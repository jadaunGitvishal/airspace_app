...
export default function ParkingSpaceDetails({ navigation }) {
	return (
		<Background>
			<View
					...
					<View className="px-4">
						...
						>
							...
							<Text className="text-justify mb-4">
								We provide the best consectetur adipisicing elit. Totam culpa,
								nam aperiam voluptatum quis similique quaerat porro vel
								laudantium hic.
							</Text>
							...
							<View className="flex-row items-center">
								...
								<Text className="font-medium">4 Parking Blocks</Text>
							</View>
							...
							<View className="flex-row items-center">
								...
								<Text className="font-medium">130 Parking Slots</Text>
							</View>
							...
							<View className="flex-row items-center pl-6 mt-1">
								...
								<Text className="font-medium">80 Shaded</Text>
							</View>
							...
							<View className="flex-row items-center pl-6">
								...
								<Text className="font-medium">50 Non Shaded</Text>
							</View>
							...
							<View className="flex-row items-center pl-6 mt-1">
								...
								<Text className="font-medium">80 Reservation Slots</Text>
							</View>
							...
							<View className="flex-row items-center pl-6">
								...
								<Text className="font-medium">50 Free Slots</Text>
							</View>
